        ...
        <div className='max-w-7xl mx-auto grid md:grid-cols-3 gap-8'>
            ...
            <div className='px-6 py-4 border-2 rounded-2xl w-100'>
                <h1 className='text-xl font-semibold gap-2'>
                    ...
                    [Class 01] : Master Core Concepts  With Star Teachers in 2 Days</h1>
                    ...
                    <div className='flex items-center justify-between mt-4'>
                        ...
                        <span className='text-white bg-[#72bf6a] px-3 py-1 rounded-full cursor-pointer'>Enroll</span>
                    </div>
            </div>
            ...
            <div className='px-6 py-4 border-2 rounded-2xl w-100'>
                <h1 className='text-xl font-semibold gap-2'>
                    ...
                    Live Interactive Full Syllabus Course for Class 1 (2026 - 27)</h1>
                    ...
                    <div className='flex mt-10 mb-5 justify-between pr-10'>
                        <img src={img1} alt="" sizes='w-15' className='w-15 h-15 rounded-full'/>
                        <img src={img2} alt="" sizes='w-15' className='w-15 h-15 rounded-full bg-white'/>
                        <img src={img3} alt="" sizes='w-15' className='w-15 h-15 rounded-full bg-white'/>
                    </div>
